...
const LeaderCardSkeleton = () => {
  return (
    <div
      className="relative w-[90%] rounded-md mx-auto mb-3 p-5 flex justify-between
        bg-neutral-300 before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r before:from-transparent before:via-white/20 hover:shadow-lg before:animate-[shimmer_1.5s_infinite]">
